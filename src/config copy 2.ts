  ...
  skills: [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Spring Cloud', level: 5 },
        { name: 'Maven / Gradle', level: 4 },
        { name: 'GitHub Apps', level: 5 },
        { name: 'Hubot', level: 4 },
      ],
    },
    {
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Helm / Kustomize', level: 4 },
        { name: 'ARM Templates', level: 3 },
        { name: 'DNS / Load Balancing', level: 4 },
        { name: 'Reverse Proxy', level: 4 },
        { name: 'Redis', level: 3 },
      ],
    },
    {
      ...
      icon: 'GitBranch',
      skills: [
        { name: 'GitHub / GitHub Enterprise', level: 5 },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'CosmosDB', level: 5 },
        { name: 'NoSQL (general)', level: 3 },
        { name: 'RESTful Services', level: 5 },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Azure App Insights', level: 4 },
        { name: 'Grafana', level: 3 },
        { name: 'Prometheus', level: 3 },
        { name: 'Splunk', level: 3 },
        { name: 'Dynatrace', level: 2 },
        { name: 'New Relic', level: 2 },
      ],
    },
    {
      category: 'Testing',
      ...
      skills: [
        ...
        { name: 'JUnit / xUnit / MSTest', level: 3 },
        { name: 'Mocha', level: 3 },
        { name: 'JMeter / BlazeMeter', level: 3 },
        { name: 'SauceLabs / TestCafe', level: 2 },
      ],
    },
    {
      ...
      skills: [
        ...
        { name: 'Zero-Trust Design', level: 4 },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'GPT-4 / OpenAI', level: 4 },
        { name: 'Gemini Pro', level: 3 },
        { name: 'RAG Pipelines', level: 3 },
        { name: 'ollama (local models)', level: 2 },
        { name: 'Docusaurus / MkDocs', level: 4 },
      ],
    },
  ],
